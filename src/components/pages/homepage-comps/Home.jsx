      ...
      <section name="Home" className='relative w-full md:h-screen h-unset'>
        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 py-16 md:py-0 md:flex-row md:gap-8'>
          ...
          <div className='flex flex-col justify-center items-center h-[85%] md:h-full order-2 md:order-1 md:items-start'>
            ...
            <h1 className='text-4xl md:text-6xl font-bold text-white mb-2 mt-3 md:mt-0 md:mb-4'>I'm Hamza Ahmad</h1>
            <h2 className='rounded-md bg-primary-color/20 max-w-max px-6 inline text-xl md:text-3xl lg:text-4xl font-semibold text-white'>AI/ML Engineer & Full Stack Developer </h2>
            <p className='text-gray-300 py-4 max-x-md text-justify'>AI/ML Engineer by curiosity, Full Stack Developer by craft – I build intelligent systems that think and web experiences that delight. From neural networks to pixel-perfect UIs, I bridge the gap between algorithms and human needs.</p>
          ...
          <div className='flex order-1 md:order-2 mt-8 md:mt-0'>
              <img src={`${import.meta.env.BASE_URL}images/diegoAI.webp`} alt="My profile" className='mb-2 rounded-2xl mx-auto w-2/3 max-w-lg md:max-w-sm object-cover md:w-[70rem] shadow-2xl shadow-primary-color/20' style={{ filter: 'drop-shadow(0px -4px 4px rgba(0, 255, 0, 0.5))' }} />
