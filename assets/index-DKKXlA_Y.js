 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var b0;function Oy(){return b0||(b0=1,function(s){function e(I,Z){var Y=I.length;I.push(Z);e:for(;0<Y;){var be=Y-1>>>1,N=I[be];if(0<l(N,Z))I[be]=Z,I[Y]=N,Y=be;else break e}}function i(I){return I.length===0?null:I[0]}function r(I){if(I.length===0)return null;var Z=I[0],Y=I.pop();if(Y!==Z){I[0]=Y;e:for(var be=0,N=I.length,te=N>>>1;be<te;){var ye=2*(be+1)-1,Me=I[ye],J=ye+1,_e=I[J];if(0>l(Me,Y))J<N&&0>l(_e,Me)?(I[be]=_e,I[J]=Y,be=J):(I[be]=Me,I[ye]=Y,be=ye);else if(J<N&&0>l(_e,Y))I[be]=_e,I[J]=Y,be=J;else break e}}return Z}function l(I,Z){var Y=I.sortIndex-Z.sortIndex;return Y!==0?Y:I.id-Z.id}if(s.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;s.unstable_now=function(){return u.now()}}else{var h=Date,d=h.now();s.unstable_now=function(){return h.now()-d}}var m=[],p=[],g=1,x=null,v=3,M=!1,E=!1,A=!1,y=!1,_=typeof setTimeout=="function"?setTimeout:null,U=typeof clearTimeout=="function"?clearTimeout:null,L=typeof setImmediate<"u"?setImmediate:null;function C(I){for(var Z=i(p);Z!==null;){if(Z.callback===null)r(p);else if(Z.startTime<=I)r(p),Z.sortIndex=Z.expirationTime,e(m,Z);else break;Z=i(p)}}function F(I){if(A=!1,C(I),!E)if(i(m)!==null)E=!0,B||(B=!0,le());else{var Z=i(p);Z!==null&&pe(F,Z.startTime-I)}}var B=!1,z=-1,X=5,D=-1;function w(){return y?!0:!(s.unstable_now()-D<X)}function G(){if(y=!1,B){var I=s.unstable_now();D=I;var Z=!0;try{e:{E=!1,A&&(A=!1,U(z),z=-1),M=!0;var Y=v;try{t:{for(C(I),x=i(m);x!==null&&!(x.expirationTime>I&&w());){var be=x.callback;if(typeof be=="function"){x.callback=null,v=x.priorityLevel;var N=be(x.expirationTime<=I);if(I=s.unstable_now(),typeof N=="function"){x.callback=N,C(I),Z=!0;break t}x===i(m)&&r(m),C(I)}else r(m);x=i(m)}if(x!==null)Z=!0;else{var te=i(p);te!==null&&pe(F,te.startTime-I),Z=!1}}break e}finally{x=null,v=Y,M=!1}Z=void 0}}finally{Z?le():B=!1}}}var le;if(typeof L=="function")le=function(){L(G)};else if(typeof MessageChannel<"u"){var se=new MessageChannel,ge=se.port2;se.port1.onmessage=G,le=function(){ge.postMessage(null)}}else le=function(){_(G,0)};function pe(I,Z){z=_(function(){I(s.unstable_now())},Z)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(I){I.callback=null},s.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):X=0<I?Math.floor(1e3/I):5},s.unstable_getCurrentPriorityLevel=function(){return v},s.unstable_next=function(I){switch(v){case 1:case 2:case 3:var Z=3;break;default:Z=v}var Y=v;v=Z;try{return I()}finally{v=Y}},s.unstable_requestPaint=function(){y=!0},s.unstable_runWithPriority=function(I,Z){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var Y=v;v=I;try{return Z()}finally{v=Y}},s.unstable_scheduleCallback=function(I,Z,Y){var be=s.unstable_now();switch(typeof Y=="object"&&Y!==null?(Y=Y.delay,Y=typeof Y=="number"&&0<Y?be+Y:be):Y=be,I){case 1:var N=-1;break;case 2:N=250;break;case 5:N=1073741823;break;case 4:N=1e4;break;default:N=5e3}return N=Y+N,I={id:g++,callback:Z,priorityLevel:I,startTime:Y,expirationTime:N,sortIndex:-1},Y>be?(I.sortIndex=Y,e(p,I),i(m)===null&&I===i(p)&&(A?(U(z),z=-1):A=!0,pe(F,Y-be))):(I.sortIndex=N,e(m,I),E||M||(E=!0,B||(B=!0,le()))),I},s.unstable_shouldYield=w,s.unstable_wrapCallback=function(I){var Z=v;return function(){var Y=v;v=Z;try{return I.apply(this,arguments)}finally{v=Y}}}}(nh)),nh}var T0;function Py(){return T0||(T0=1,th.exports=Oy()),th.exports}var ih={exports:{}},wn={};/**
 * @license React
...
#define LOW_PRECISION`),e}function kA(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Q_?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===dM?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===aa&&(e="SHADOWMAP_TYPE_VSM"),e}function XA(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case ws:case Cs:e="ENVMAP_TYPE_CUBE";break;case Yu:e="ENVMAP_TYPE_CUBE_UV";break}return e}function WA(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Cs:e="ENVMAP_MODE_REFRACTION";break}return e}function qA(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case J_:e="ENVMAP_BLENDING_MULTIPLY";break;case LM:e="ENVMAP_BLENDING_MIX";break;case NM:e="ENVMAP_BLENDING_ADD";break}return e}function YA(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),7*16)),texelHeight:r,maxMip:i}}function jA(s,e,i,r){const l=s.getContext(),u=i.defines;let h=i.vertexShader,d=i.fragmentShader;const m=kA(i),p=XA(i),g=WA(i),x=qA(i),v=YA(i),M=PA(i),E=zA(u),A=l.createProgram();let y,_,U=i.glslVersion?"#version "+i.glslVersion+`
...
`)+`
`+_);const L=U+y+h,C=U+_+d,F=b_(l,l.VERTEX_SHADER,L),B=b_(l,l.FRAGMENT_SHADER,C);l.attachShader(A,F),l.attachShader(A,B),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function z(G){if(s.debug.checkShaderErrors){const le=l.getProgramInfoLog(A).trim(),se=l.getShaderInfoLog(F).trim(),ge=l.getShaderInfoLog(B).trim();let pe=!0,I=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if(pe=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,A,F,B);else{const Z=A_(l,F,"vertex"),Y=A_(l,B,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
