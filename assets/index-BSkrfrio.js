...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:qa,depthTest:!1,depthWrite:!1})}function m_(){return new Za({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qd(),fragmentShader:`
		...
		`,blending:qa,depthTest:!1,depthWrite:!1})}function g_(){return new Za({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qd(),fragmentShader:`
		...
		`,blending:qa,depthTest:!1,depthWrite:!1})}function qd(){return`
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const TR=de.forwardRef(({color:s="currentColor",size:e=24,strokeWidth:i=2,absoluteStrokeWidth:r,className:l="",children:u,iconNode:h,...d},m)=>de.createElement("svg",{ref:m,...bR,width:e,height:e,stroke:s,strokeWidth:r?Number(i)*24/Number(e):i,className:Rv("lucide",l),...d},[...h.map(([p,g])=>de.createElement(p,g)),...Array.isArray(u)?u:[u]]));/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const vi=(s,e)=>{const i=de.forwardRef(({className:r,...l},u)=>de.createElement(TR,{ref:u,iconNode:e,className:Rv(`lucide-${ER(s)}`,r),...l}));return i.displayName=`${s}`,i};/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
